...
public class OntimizeLAFParseUtils {
	...
	/**
	 * Parses a String to convert it to a boolean. If the String value is 'yes' or 'true' the boolean response will be true, and if the String value is
	 * 'no' or 'false' the result will be false. If the String is not one of the previous one specified previously, the defaultValue will be returned.
	 *
	 * @param string
	 *           the string to parse
	 * @param defaultValue
	 *           the default value to return if no coincidence found
	 * @return
	 */
	...
	/**
	 * Receives an string (named color) with the codification of several colours (in both RGB and Hexadecimal) splitted by ~ and returns an Color array with
	 * those colours.
	 *
	 * @param color
	 * @param defaultColor
	...
	/**
	 * Parse the sent string (named color), checking the cache or converting the string to return a color for that encoded string.
	 * If the value is wrong enconded and also it does not exist in the cache, this method returns defaultColor.
	 *
	 * @param color
	 * @param defaultColor
	 * @return
	...
	public static Insets parseInsets(String insets, Insets defaultValue) throws IllegalArgumentException {
		...
		// Parsing the received insets String to get an InsetsUIResource Object and caching and returning it:
	...
	/**
	 * Receives an string (named floats) with the codification of several floats splitted by ~ and returns a float array with those floats.
	 *
	 * @param floats
	...
	/**
	 * Parse the string dim to get a dimension value. The syntax of the dim variable must be two integer splitted by ;
	 *             A;B = new Dimension (A, B)
	 * By default, defaultValue is returned
	 *
	 * @param dim
	 * @param defaultValue
	 * @return
