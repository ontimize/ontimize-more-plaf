...
public class OntimizeTitlePane extends JComponent {
    ...
    protected class SystemMenuBar extends JMenuBar {
        ...
        public void paint(Graphics g) {
            ...
            if (OntimizeTitlePane.this.systemIcon != null) {
                g.drawImage(OntimizeTitlePane.this.systemIcon, 0, 0, OntimizeTitlePane.IMAGE_WIDTH,
                        OntimizeTitlePane.IMAGE_HEIGHT, null);
            } else {
        ...
        public Dimension getPreferredSize() {
            ...
            return new Dimension(Math.max(OntimizeTitlePane.IMAGE_WIDTH, size.width),
                    Math.max(size.height, OntimizeTitlePane.IMAGE_HEIGHT));
        }
    ...
    protected class TitlePaneLayout implements LayoutManager {
        ...
        public void layoutContainer(Container c) {
            boolean leftToRight = (OntimizeTitlePane.this.window == null)
                    ? OntimizeTitlePane.this.getRootPane().getComponentOrientation().isLeftToRight()
            ...
            if ((OntimizeTitlePane.this.closeButton != null)
                    && (OntimizeTitlePane.this.closeButton.getIcon() != null)) {
            ...
            if (OntimizeTitlePane.this.getWindowDecorationStyle() == JRootPane.FRAME) {
                ...
                if ((OntimizeTitlePane.this.iconifyButton != null)
                        && (OntimizeTitlePane.this.iconifyButton.getParent() != null)) {
                    spacing = 2;
                    x += leftToRight ? -spacing - buttonWidth : spacing;
    ...
    protected void updateSystemIcon() {
        ...
        if (icons.size() == 0) {
            ...
            this.systemIcon = SunToolkit.getScaledIconImage(icons, OntimizeTitlePane.IMAGE_WIDTH,
                    OntimizeTitlePane.IMAGE_HEIGHT);
        }
    }
