...
//        ContextUtils.getPainter(context).paintToolBarBorder(context, g, x, y, w, h, toolBar.getOrientation());
    ...
    protected void paint(SynthContext context, Graphics g) {
        if (handleIcon != null && toolBar.isFloatable()) {
            ...
            SynthGraphicsUtils.paintIcon(handleIcon, context, g, startX, 0, SynthGraphicsUtils.getIconWidth(handleIcon, context), SynthGraphicsUtils.getIconHeight(
                handleIcon, context));
        }
    ...
    class SynthToolBarLayoutManager implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (tb.getOrientation() == JToolBar.HORIZONTAL) {
                int handleWidth = tb.isFloatable() ? SynthGraphicsUtils.getIconWidth(handleIcon, context) : 0;
                ...
                int handleHeight = tb.isFloatable() ? SynthGraphicsUtils.getIconHeight(handleIcon, context) : 0;
