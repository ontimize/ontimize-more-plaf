            ...
            try {
                ...
                if ((this.path != null) && (this.ctx != null)) {
                    try {
                        ...
                        return ReflectionUtils.newInstance(this.className, this.which, this.ctx,
                                this.getClass().getClassLoader().getResource(this.path));
                    }
                    ...
                    if (constructor == null) {
                        throw new NullPointerException(
                                "Failed to find the constructor for the class: " + this.className);
                    }
                    ...
                    c = Class.forName(this.className, true, (ClassLoader) cl);
                    Class paintContextClass = Class.forName(
                            "com.ontimize.plaf.painter.AbstractRegionPainter$PaintContext", true, (ClassLoader) cl);
