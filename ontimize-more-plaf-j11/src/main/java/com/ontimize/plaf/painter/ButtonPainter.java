...
public class ButtonPainter extends ImagePainter {
    ...
    public ButtonPainter(int which, boolean tiles, boolean paintCenter, Insets sourceInsets, Insets destinationInsets,
    ...
    protected void doPaint(Graphics2D g, JComponent c, int width, int height, Object[] extendedCacheKeys) {
        ...
        switch (state) {
            ...
            // case BACKGROUND_MOUSEOVER_DEFAULT_FOCUSED: paintBackgroundMouseOverAndDefaultAndFocused(g);
            // break;
