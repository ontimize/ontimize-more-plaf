...
public class OFormTabbedPaneTabAreaPainter extends AbstractRegionPainter {
    ...
    protected void init() {
        // disable:
        this.backgroundColorDisabled = this.getConfiguredPaint(this.getComponentKeyName() + "[Disabled].background",
                this.color10);
        this.backgroundColorEnabled = this.getConfiguredPaint(this.getComponentKeyName() + "[Enabled].background",
                this.color2);
    }
