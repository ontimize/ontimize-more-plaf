...
public class OTableHeaderPainter extends AbstractRegionPainter {
	...
	protected void init() {
		...
		// Ascending:
		Object obj = UIManager.getLookAndFeelDefaults().get(this.getComponentKeyName() + ".ascendingSortIconBackground");
	...
	protected void paintascendingSortIconEnabled(Graphics2D g, JComponent c) {
		...
		this.ellipse = new Ellipse2D.Float(this.decodeX(1.5161290322f), this.decodeY(1.1176470588f), this.decodeX(1.3870967741f), this.decodeY(1.7058823529f));
	...
	protected Path2D decodeBackgroundShape() {
		...
		this.path.curveTo(this.decodeX(1.8709677419f), this.decodeY(1.0f), this.decodeX(2.0f), this.decodeY(1.2352941176f), this.decodeX(2.0f), this.decodeY(1.4705882352f));
		this.path.curveTo(this.decodeX(2.0f), this.decodeY(1.7058823529f), this.decodeX(1.8709677419f), this.decodeY(1.9411764705f), this.decodeX(1.7419354838f),
				this.decodeY(1.9411764705f));
		this.path.lineTo(this.decodeX(1.2580645161f), this.decodeY(1.9411764705f));
		this.path.curveTo(this.decodeX(1.1290322580f), this.decodeY(1.9411764705f), this.decodeX(1.0f), this.decodeY(1.7058823529f), this.decodeX(1.0f),
				this.decodeY(1.4705882352f));
		this.path.curveTo(this.decodeX(1.0f), this.decodeY(1.2352941176f), this.decodeX(1.1290322580f), this.decodeY(1.0f), this.decodeX(1.2580645161f), this.decodeY(1.0f));
		this.path.closePath();
