...
public abstract class AbstractOButtonPainter extends AbstractRegionPainter {
	...
	protected Object[] getExtendedCacheKeys(JComponent c) {
		...
		switch (this.state) {
		case BACKGROUND_DEFAULT:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color4, -0.6197143f, 0.43137252f, 0),
		...
		case BACKGROUND_DEFAULT_FOCUSED:
			...
			break;
		case BACKGROUND_MOUSEOVER_DEFAULT:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color12, -0.6198413f, 0.43921566f, 0),
		...
		case BACKGROUND_MOUSEOVER_DEFAULT_FOCUSED:
			...
			break;
		case BACKGROUND_PRESSED_DEFAULT:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color20, -0.38050595f, 0.20392156f, 0),
					this.getComponentColor(c, "background", this.color21, -0.29863563f, 0.1490196f, 0), this.getComponentColor(c, "background", this.color22, 0.0f, 0.0f, 0),
		...
		case BACKGROUND_PRESSED_DEFAULT_FOCUSED:
			...
			break;
		case BACKGROUND_ENABLED:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color35, -0.10655806f, 0.24313724f, 0),
		...
		case BACKGROUND_FOCUSED:
			...
			break;
		case BACKGROUND_MOUSEOVER:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color41, -0.10658931f, 0.25098038f, 0),
		...
		case BACKGROUND_MOUSEOVER_FOCUSED:
			...
			break;
		case BACKGROUND_PRESSED:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color47, -0.05960039f, 0.10196078f, 0),
	...
	protected AlphaComposite getDerivedAlphaComposite() {
		...
		case BACKGROUND_DEFAULT:
			alpha = AlphaComposite.SrcOver
					.derive(((this.alphaDefaultPercent >= 0) && (this.alphaDefaultPercent <= 1)) ? this.alphaDefaultPercent : this.defaultAlphaDefaultPercent);
			break;
		case BACKGROUND_DEFAULT_FOCUSED:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaFocusedDefaultPercent >= 0) && (this.alphaFocusedDefaultPercent <= 1)) ? this.alphaFocusedDefaultPercent
					: this.defaultAlphaFocusedDefaultPercent);
			break;
		case BACKGROUND_MOUSEOVER_DEFAULT:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaMouseOverDefaultPercent >= 0) && (this.alphaMouseOverDefaultPercent <= 1)) ? this.alphaMouseOverDefaultPercent
		...
		case BACKGROUND_MOUSEOVER_DEFAULT_FOCUSED:
			...
			break;
		case BACKGROUND_PRESSED_DEFAULT:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaPressedDefaultPercent >= 0) && (this.alphaPressedDefaultPercent <= 1)) ? this.alphaPressedDefaultPercent
		...
		case BACKGROUND_PRESSED_DEFAULT_FOCUSED:
			...
			break;
		case BACKGROUND_DISABLED:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaDisabledPercent >= 0) && (this.alphaDisabledPercent <= 1)) ? this.alphaDisabledPercent
					: this.defaultAlphaDisabledPercent);
			break;
		case BACKGROUND_ENABLED:
			alpha = AlphaComposite.SrcOver
					.derive(((this.alphaEnabledPercent >= 0) && (this.alphaEnabledPercent <= 1)) ? this.alphaEnabledPercent : this.defaultAlphaEnabledPercent);
			break;
		case BACKGROUND_FOCUSED:
			alpha = AlphaComposite.SrcOver
					.derive(((this.alphaFocusedPercent >= 0) && (this.alphaFocusedPercent <= 1)) ? this.alphaFocusedPercent : this.defaultAlphaFocusedPercent);
			break;
		case BACKGROUND_MOUSEOVER:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaMouseOverPercent >= 0) && (this.alphaMouseOverPercent <= 1)) ? this.alphaMouseOverPercent
					: this.defaultAlphaMouseOverPercent);
			break;
		case BACKGROUND_MOUSEOVER_FOCUSED:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaMouseOverFocusedPercent >= 0) && (this.alphaMouseOverFocusedPercent <= 1)) ? this.alphaMouseOverFocusedPercent
					: this.defaultAlphaMouseOverFocusedPercent);
			break;
		case BACKGROUND_PRESSED:
			alpha = AlphaComposite.SrcOver
					.derive(((this.alphaPressedPercent >= 0) && (this.alphaPressedPercent <= 1)) ? this.alphaPressedPercent : this.defaultAlphaPressedPercent);
			break;
		case BACKGROUND_PRESSED_FOCUSED:
			alpha = AlphaComposite.SrcOver.derive(((this.alphaPressedFocusedPercent >= 0) && (this.alphaPressedFocusedPercent <= 1)) ? this.alphaPressedFocusedPercent
	...
	protected Paint decodeGradient1(Shape s) {
		...
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.05f, 0.5f, 0.95f },
	...
	protected Paint decodeGradient2(Shape s) {
		...
		return this.decodeGradient(
				...
				new Color[] { (Color) this.componentColors[0], this.decodeColor((Color) this.componentColors[0], (Color) this.componentColors[1], 0.5f),
						(Color) this.componentColors[1], this.decodeColor((Color) this.componentColors[1], (Color) this.componentColors[2], 0.5f), (Color) this.componentColors[2],
						this.decodeColor((Color) this.componentColors[2], (Color) this.componentColors[2], 0.5f), (Color) this.componentColors[2],
						this.decodeColor((Color) this.componentColors[2], (Color) this.componentColors[3], 0.5f), (Color) this.componentColors[3],
						this.decodeColor((Color) this.componentColors[3], (Color) this.componentColors[4], 0.5f), (Color) this.componentColors[4] });
	}
	...
	protected Paint decodeGradient3(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.05f, 0.5f, 0.95f },
				new Color[] { this.color10, this.decodeColor(this.color10, this.color11, 0.5f), this.color11 });
	}
	...
	protected Paint decodeGradient4(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.05f, 0.5f, 0.95f },
				new Color[] { this.color18, this.decodeColor(this.color18, this.color19, 0.5f), this.color19 });
	}
	...
	protected Paint decodeGradient5(Shape s) {
		...
		float w = (float) bounds.getWidth();
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.09f, 0.52f, 0.95f },
				new Color[] { this.color26, this.decodeColor(this.color26, this.color27, 0.5f), this.color27 });
	}
	...
	protected Paint decodeGradient6(Shape s) {
		...
		return this.decodeGradient(
				...
				new Color[] { this.color28, this.decodeColor(this.color28, this.color29, 0.5f), this.color29, this.decodeColor(this.color29, this.color30, 0.5f), this.color30,
						this.decodeColor(this.color30, this.color30, 0.5f), this.color30, this.decodeColor(this.color30, this.color31, 0.5f), this.color31,
	...
	protected Paint decodeGradient7(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.09f, 0.52f, 0.95f },
				new Color[] { this.color33, this.decodeColor(this.color33, this.color34, 0.5f), this.color34 });
	}
	...
	protected Paint decodeGradient9(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.09f, 0.52f, 0.95f },
				new Color[] { this.color39, this.decodeColor(this.color39, this.color40, 0.5f), this.color40 });
	}
	...
	protected Paint decodeGradient10(Shape s) {
		...
		return this.decodeGradient(
				...
				new Color[] { (Color) this.componentColors[0], this.decodeColor((Color) this.componentColors[0], (Color) this.componentColors[1], 0.5f),
						...
						this.decodeColor((Color) this.componentColors[2], (Color) this.componentColors[2], 0.5f), (Color) this.componentColors[2],
						this.decodeColor((Color) this.componentColors[2], (Color) this.componentColors[3], 0.5f), (Color) this.componentColors[3],
						this.decodeColor((Color) this.componentColors[3], (Color) this.componentColors[3], 0.5f), (Color) this.componentColors[3] });
	}
	...
	protected Paint decodeGradient11(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.05f, 0.5f, 0.95f },
				new Color[] { this.color45, this.decodeColor(this.color45, this.color46, 0.5f), this.color46 });
	}
}