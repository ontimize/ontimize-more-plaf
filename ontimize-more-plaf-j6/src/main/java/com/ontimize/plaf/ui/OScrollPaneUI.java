 ...
 * 
 * $Id: OScrollPaneUI.java,v 1.11 2013/06/25 06:27:23 daniel.grana Exp $
 */
...
public class OScrollPaneUI extends BasicScrollPaneUI implements PropertyChangeListener, ScrollPaneConstants, SynthUI {
    ...
    protected com.sun.java.swing.Painter                  cornerPainter;
    ...
    protected void installDefaults(JScrollPane scrollpane) {
        ...
        if (obj != null && obj instanceof com.sun.java.swing.Painter) {
            cornerPainter = (com.sun.java.swing.Painter) obj;
        }
    ...
    protected void paintScrollPaneCorner(Graphics g, JComponent c) {
        ...
        cornerPainter.paint(g2, c, 24, 24);
    }
    ...
    protected boolean containsTableComponent(JComponent c){
    	...
    	if(comps!=null && comps.length>0){
    		for(int i=0;i<comps.length;i++){
    			...
    			if(current instanceof JComponent && current.getClass().isAssignableFrom(JViewport.class)){
    				JComponent jC = (JComponent)current;
    				if(jC.getComponents().length>0 && jC.getComponents()[0] instanceof EJTable ){
    					return true;
    				}
    			}
    		}
