...
public class OntimizeLAFUtils {
	...
	/**
	 * Fill the uidefaults Object (from OntimizeLookAndFeel class) with the property indicated by property in the custom configuration properties (if it exists).
	 * If it does not not exist or it does not contain that property, this method get the property in the default configuration properties of
	 * the Ontimize Look And Feel, that is, get the default value for that property in the Ontimize L&F.
	 *
	 * In case that the method obtains a not-null-value or a not-empty-value the uidefaults Object if popullated with that value for the key named property.
	 *
	 * @param property
	 * @return
	 */
	 ...
	 * In case that the method obtains a not-null-value or a not-empty-value the uidefaults Object if popullated with that value for the key named property.
	 *
	 * In other case, the method fills the uidefaults Object with the sent defaultValue, if it is not null and not empty.
	 *
	 * @param property
	 * @param defaultValue
	 * @return
	...
	/**
	 * Get the property indicated by key in the custom configuration properties (if it exists).
	 * If it does not not exist or it does not contain that property, this method get the property in the default configuration properties of
	 * the Ontimize Look And Feel, that is, return the default value for that property in the Ontimize L&F.
	 *
