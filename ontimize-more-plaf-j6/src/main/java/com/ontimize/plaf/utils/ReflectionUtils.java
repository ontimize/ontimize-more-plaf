...
public final class ReflectionUtils {
	...
	/**
	 * Check all interfaces of <code>theClass</code> that implements
	...
	/**
	 * Returns a method from a {@link Class} by name. Note!!: no polimorphims
	 * allowed in the class for the method
	 *
	 * @param theClass
	 *            the the class
	 * @param name
	...
	public static Object invoke(Object toInvoke, String methodName, Object... parameters) {
		Method method = ReflectionUtils.getMethodByNameAndParatemerNumber((toInvoke instanceof Class) ? (Class<?>) toInvoke : toInvoke.getClass(),
