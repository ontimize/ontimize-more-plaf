 ...
 * <pre>
 * &lt;code&gt;
 *     public class IndeterminateState extends State&lt;JProgressBar&gt; {
...
public abstract class State<T extends JComponent> {
     ...
     *
     * @author  $author$
     * @version $Revision: 1.4 $, $Date: 2013/06/25 06:27:06 $
     */
    public static class StandardState extends State<JComponent> {
        protected int state;
         ...
         */
        protected StandardState(int state) {
        ...
        /**
         * @see com.ontimize.plaf.state.State#isInState(JComponent, int)
         */
        ...
        /**
         * @see com.ontimize.plaf.state.State#isInState(JComponent)
         */
