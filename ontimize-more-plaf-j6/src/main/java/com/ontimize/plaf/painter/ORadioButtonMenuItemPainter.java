...
/**
 * Class that paints the radio button menu item background and the check icons depending on the element status (enable, disable, mouse over, selected and combinations).
...
public class ORadioButtonMenuItemPainter  extends AbstractRegionPainter {
	...
	protected void init (){
		...
		// disable:
		Object obj = UIManager.getLookAndFeelDefaults().get("RadioButtonMenuItem[Disabled].background");
		...
		// enable:
		obj = UIManager.getLookAndFeelDefaults().get( "RadioButtonMenuItem[Enabled].background");
		if(obj instanceof Paint){
		...
		// selected:
		obj = UIManager.getLookAndFeelDefaults().get( "RadioButtonMenuItem[Selected].background");
		if(obj instanceof Paint){
		...
		// mouseover:
		obj = UIManager.getLookAndFeelDefaults().get( "RadioButtonMenuItem[MouseOver].background");
		if(obj instanceof Paint){
		...
		// selected+mouseover:
		obj = UIManager.getLookAndFeelDefaults().get( "RadioButtonMenuItem[MouseOver+Selected].background");
		if(obj instanceof Paint){
