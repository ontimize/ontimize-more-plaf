...
/**
 * A SynthStyle implementation used by Ontimize. This just wraps a SynthStyle with a Ontimize style
 * in order to get at some SynthStyle methods that are package local.
 *
...
public class OntimizeStyleWrapper extends SynthStyle implements OntimizeStyle {
    ...
    /**
     * The SynthPainter that will be returned from this OntimizeStyle. The SynthPainter returned will be
     * a OntimizeSynthPainterImpl, which will in turn delegate back to this OntimizeStyle for the proper
     * Painter (not SynthPainter) to use for painting the foreground, background, or border.
     */
    ...
    /**
     * Create a new OntimizeStyle. Only the prefix must be supplied. At the appropriate time,
     * installDefaults will be called. At that point, all of the state information will be pulled from
     * UIManager and stored locally within this style.
     * @param style Something like Button or Slider.Thumb or org.jdesktop.swingx.JXStatusBar or
    ...
    /**
     * Gets the appropriate background Painter, if there is one, for the state specified in the given
     * SynthContext. This method does appropriate fallback searching, as described in #get.
    ...
    /**
     * Gets the appropriate foreground Painter, if there is one, for the state specified in the given
     * SynthContext. This method does appropriate fallback searching, as described in #get.
     * @param ctx The SynthContext. Must not be null.
    ...
    /**
     * Gets the appropriate border Painter, if there is one, for the state specified in the given
     * SynthContext. This method does appropriate fallback searching, as described in #get.
     * @param ctx The SynthContext. Must not be null.
