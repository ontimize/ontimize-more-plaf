 ...
 * <p>
 * Minimum necessary copied from BasicScrollPaneUI with appropriate change to support Apple-style
...
public class OScrollPaneUI extends BasicScrollPaneUI implements PropertyChangeListener, ScrollPaneConstants, SynthUI {
    ...
    /**
     * State flag that shows whether setValue() was called from a user program before the value of
     * "extent" was set in right-to-left component orientation.
     */
    ...
    public void update(Graphics g, JComponent c) {
        ...
        ContextUtils.getPainter(context)
            .paintScrollPaneBackground(context, g, 0, 0, context.getComponent().getWidth(),
                    context.getComponent().getHeight());
    ...
    protected void paintScrollPaneCorner(Graphics g, JComponent c) {
        ...
        if ((this.scrollpane.getHorizontalScrollBar() == null)
                || !this.scrollpane.getHorizontalScrollBar().isVisible()) {
            return;
        }
    ...
    /**
     * Returns a <code>PropertyChangeListener</code> that will be installed on the horizontal
    ...
    /**
     * Returns a <code>PropertyChangeListener</code> that will be installed on the vertical
     * <code>JScrollBar</code>.
     */
     ...
     * MouseWheelHandler responds to MouseWheelEvents by scrolling the JScrollPane appropriately. If the
     * scroll pane's <code>isWheelScrollingEnabled</code> method returns false, no scrolling occurs.
     *
    ...
    /**
     * Creates an instance of MouseWheelListener, which is added to the JScrollPane by installUI(). The
     * returned MouseWheelListener is used to handle mouse wheel-driven scrolling.
     ...
     * Subclasses can override this method to return a custom PropertyChangeListener, e.g.
     *
     * <pre>
    ...
    class Handler implements ChangeListener, PropertyChangeListener, MouseWheelListener {
         ...
         *
         * If limitByBlock is set to true, the scrollbar will scroll at least 1 unit increment, but will not
         * scroll farther than the block increment. See BasicScrollPaneUI.Handler.mouseWheelMoved().
         */
        ...
        protected void hsbStateChanged(JViewport viewport, ChangeEvent e) {
            ...
            if (OScrollPaneUI.this.scrollpane.getComponentOrientation().isLeftToRight()) {
                ...
                if ((extent == 0) && (value != 0) && (oldX == max)) {
                    ...
                    /*
                     * When a pane without a horizontal scroll bar was reduced and the bar appeared, the viewport should
