...
public class OFormTabbedPaneUI extends BasicTabbedPaneUI implements SynthUI, PropertyChangeListener, TabbedPanePopup {
    ...
    protected void updateStyle(JTabbedPane c) {
        ...
        SynthContext tabAreaContext = this.getContext(c, OntimizeRegion.FORM_TABBED_PANE_TAB_AREA,
                SynthConstants.ENABLED);
        ...
        SynthContext tabContentContext = this.getContext(c, OntimizeRegion.FORM_TABBED_PANE_CONTENT,
                SynthConstants.ENABLED);
    ...
    protected int getBaseline(int tab) {
        ...
        SynthContext tabContext = this.getContext(this.tabPane, OntimizeRegion.FORM_TABBED_PANE_TAB,
                SynthConstants.ENABLED);
    ...
    protected void paint(SynthContext context, Graphics g) {
        ...
        SynthContext tabContentContext = this.getContext(this.tabPane, OntimizeRegion.FORM_TABBED_PANE_CONTENT,
                SynthConstants.ENABLED);
    ...
    protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
        SynthContext tabAreaContext = this.getContext(this.tabPane, OntimizeRegion.FORM_TABBED_PANE_TAB_AREA,
                SynthConstants.ENABLED);
    ...
    protected void paintScrollButtonBackground(SynthContext ss, Graphics g, JButton scrollButton) {
        ...
        this.tabPane.putClientProperty("JTabbedPane.Tab.segmentPosition",
                ((scrollButton == this.scrollBackwardButton) ^ flipSegments) ? "first" : "last");
    ...
    protected class OntimizeTabbedPaneLayout extends TabbedPaneLayout {
        ...
        public void layoutContainer(Container parent) {
            ...
            for (int i = 0; i < OFormTabbedPaneUI.this.tabPane.getComponentCount(); i++) {
                ...
                if ((child != OFormTabbedPaneUI.this.scrollBackwardButton)
                        && (child != OFormTabbedPaneUI.this.scrollForwardButton)
            ...
            if (shouldChangeFocus
                    && !SwingUtilities2.tabbedPaneChangeFocusTo(OFormTabbedPaneUI.this.getVisibleComponent())) {
        ...
        protected void setTabContainerBounds() {
            ...
            if (tabContainer != null) {
                int tabContainerX = OFormTabbedPaneUI.this.tabPlacement == SwingConstants.RIGHT
                        ? OFormTabbedPaneUI.this.contentRect.width : 0;
                int tabContainerY = OFormTabbedPaneUI.this.tabPlacement == SwingConstants.BOTTOM
                        ? OFormTabbedPaneUI.this.contentRect.height : 0;
                int tabContainerWidth = (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.LEFT)
                        || (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.RIGHT)
                                ? OFormTabbedPaneUI.this.tabPane
                                    .getWidth() - OFormTabbedPaneUI.this.contentRect.width
                                : OFormTabbedPaneUI.this.contentRect.width;
                int tabContainerHeight = (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.TOP)
                        || (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.BOTTOM)
                                ? OFormTabbedPaneUI.this.tabPane
        ...
        protected void setScrollButtonDirections() {
            if ((OFormTabbedPaneUI.this.tabPlacement == SwingConstants.LEFT)
                    || (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.RIGHT)) {
        ...
        protected void calcContentRect() {
            ...
            switch (OFormTabbedPaneUI.this.tabPlacement) {
                ...
                case LEFT:
                    cx = OFormTabbedPaneUI.this.tabAreaRect.x + OFormTabbedPaneUI.this.tabAreaRect.width
                            + contentInsets.left;
                    cy = OFormTabbedPaneUI.this.tabAreaRect.y + contentInsets.top;
                    cw = bounds.width - insets.left - insets.right - OFormTabbedPaneUI.this.tabAreaRect.width
                ...
                case BOTTOM:
                    ...
                    ch = bounds.height - insets.top - insets.bottom - OFormTabbedPaneUI.this.tabAreaRect.height
                ...
                default:
                    ...
                    cy = OFormTabbedPaneUI.this.tabAreaRect.y + OFormTabbedPaneUI.this.tabAreaRect.height
                            + contentInsets.top;
                    cw = bounds.width - insets.left - insets.right - contentInsets.left - contentInsets.right;
                    ch = bounds.height - insets.top - insets.bottom - OFormTabbedPaneUI.this.tabAreaRect.height
                            - contentInsets.top - contentInsets.bottom;
        ...
        protected void layoutTabComponents() {
            ...
            for (int i = 0; i < OFormTabbedPaneUI.this.tabPane.getTabCount(); i++) {
                ...
                c.setBounds(
                        x + OFormTabbedPaneUI.this.getTabLabelShiftX(OFormTabbedPaneUI.this.tabPlacement, i,
                                isSelected),
                        y + OFormTabbedPaneUI.this.getTabLabelShiftY(OFormTabbedPaneUI.this.tabPlacement, i,
                                isSelected),
        ...
        protected void calculateTabRects(int tabPlacement, int tabCount) {
            ...
            Dimension size = new Dimension(
                    OFormTabbedPaneUI.this.tabAreaRect.width - tabAreaInsets.left - tabAreaInsets.right,
                    OFormTabbedPaneUI.this.tabAreaRect.height
                            - tabAreaInsets.top - tabAreaInsets.bottom);
            int tabAreaLength = OFormTabbedPaneUI.this.orientation.getLength(size);
            int buttonLength = OFormTabbedPaneUI.this.orientation
                .getLength(OFormTabbedPaneUI.this.scrollForwardButton.getPreferredSize());
            ...
            int totalLength = OFormTabbedPaneUI.this.orientation.getPosition(
                    OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex].x
                            + OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex].width,
                    OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex].y
            ...
            this.setScrollButtonPositions(OFormTabbedPaneUI.this.scrollBackwardButton,
                    (OFormTabbedPaneUI.this.leadingTabIndex > 0),
                    OFormTabbedPaneUI.this.orientation.getPosition(
                            OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.leadingTabIndex]) - buttonLength);
            this.setScrollButtonPositions(
                    OFormTabbedPaneUI.this.scrollForwardButton,
                    (OFormTabbedPaneUI.this.trailingTabIndex < (tabCount - 1)),
                    OFormTabbedPaneUI.this.orientation
                        .getPosition(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex])
                            + OFormTabbedPaneUI.this.orientation
                                .getLength(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex]));
            this.setScrollButtonPositions(
                    ...
                    OFormTabbedPaneUI.this.orientation
                        .getPosition(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex])
                            + OFormTabbedPaneUI.this.orientation
                                .getLength(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.trailingTabIndex])
                            + (OFormTabbedPaneUI.this.scrollForwardButton.isVisible()
                                    ? OFormTabbedPaneUI.this.scrollForwardButton.getWidth() : 0));

            // If component orientation right to left and tab placement is on
            // the top or the bottom,
            // flip x positions and adjust by widths.
            if (!OFormTabbedPaneUI.this.tabPane.getComponentOrientation().isLeftToRight()
                    && (OFormTabbedPaneUI.this.orientation == ControlOrientation.HORIZONTAL)) {
        ...
        protected void calcTabAreaRect() {
            ...
            if (OFormTabbedPaneUI.this.orientation == ControlOrientation.HORIZONTAL) {
                ...
                offset = (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.BOTTOM)
                ...
                offset = (OFormTabbedPaneUI.this.tabPlacement == SwingConstants.RIGHT)
                        ? bounds.width - insets.right - thickness : insets.left;
            }

            OFormTabbedPaneUI.this.tabAreaRect
                .setBounds(OFormTabbedPaneUI.this.orientation.createBounds(position, offset, length, thickness));
        }
        ...
        protected void determineVisibleTabIndices(int tabCount, int selectedIndex, int tabAreaLength,
            ...
            int leadingTabOffset = OFormTabbedPaneUI.this.orientation
                .getPosition(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.leadingTabIndex]);
            int selectedTabEndOffset = OFormTabbedPaneUI.this.orientation.getPosition(
                    OFormTabbedPaneUI.this.rects[selectedIndex].x
                            + OFormTabbedPaneUI.this.rects[selectedIndex].width,
                    OFormTabbedPaneUI.this.rects[selectedIndex].y + OFormTabbedPaneUI.this.rects[selectedIndex].height);
            ...
            if (desiredMaximumLength <= tabAreaLength) {
                ...
                OFormTabbedPaneUI.this.trailingTabIndex = tabCount - 1;
            } else if (((OFormTabbedPaneUI.this.leadingTabIndex == 0)
                ...
                for (int i = tabCount - 1; i > selectedIndex; i--) {
                    int end = OFormTabbedPaneUI.this.orientation.getPosition(
                            OFormTabbedPaneUI.this.rects[i].x + OFormTabbedPaneUI.this.rects[i].width,
        ...
        protected int calcDesiredMaximumLength(int tabCount) {
            ...
            Point corner = new Point(OFormTabbedPaneUI.this.tabAreaRect.x + tabAreaInsets.left,
                    OFormTabbedPaneUI.this.tabAreaRect.y + tabAreaInsets.top);
            int offset = OFormTabbedPaneUI.this.orientation.getOrthogonalOffset(corner);
            int thickness = (OFormTabbedPaneUI.this.orientation == ControlOrientation.HORIZONTAL)
                    ? OFormTabbedPaneUI.this.maxTabWidth : OFormTabbedPaneUI.this.maxTabHeight;
            int position = 0;
            int maxTabLength = 0;

            // Run through tabs and lay them out in a single long run.
            for (int i = 0; i < tabCount; i++) {
                int length = (OFormTabbedPaneUI.this.orientation == ControlOrientation.HORIZONTAL)
                        ? OFormTabbedPaneUI.this.calculateTabWidth(SwingConstants.TOP, i, metrics)
                        : OFormTabbedPaneUI.this.calculateTabHeight(SwingConstants.LEFT, i, fontHeight);

                OFormTabbedPaneUI.this.rects[i]
                    .setBounds(OFormTabbedPaneUI.this.orientation.createBounds(position, offset, length, thickness));
        ...
        protected void resetTabPositionsToLeadingTabIndex(int tabCount) {
            ...
            int leadingTabPosition = OFormTabbedPaneUI.this.orientation
                .getPosition(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.leadingTabIndex]);
            ...
            for (int i = 0; i < tabCount; i++) {
                if ((i < OFormTabbedPaneUI.this.leadingTabIndex) || (i > OFormTabbedPaneUI.this.trailingTabIndex)) {
                    ...
                    OFormTabbedPaneUI.this.orientation.updateBoundsPosition(OFormTabbedPaneUI.this.rects[i],
                            OFormTabbedPaneUI.this.orientation.getPosition(OFormTabbedPaneUI.this.rects[i])
                                    - leadingTabPosition);
                }
            }
        }
        ...
        protected void centerTabs(int tabCount, int totalLength, int tabAreaLength) {
            ...
            int offset = OFormTabbedPaneUI.this.orientation.getOrthogonalOffset(corner);
            int thickness = (OFormTabbedPaneUI.this.orientation == ControlOrientation.HORIZONTAL)
                    ? OFormTabbedPaneUI.this.maxTabHeight : OFormTabbedPaneUI.this.maxTabWidth;
        ...
        protected void resizeTabs(int tabCount, int totalLength, int buttonLength, int tabAreaLength) {
            ...
            for (int i = OFormTabbedPaneUI.this.leadingTabIndex; i <= OFormTabbedPaneUI.this.trailingTabIndex; i++) {
                int position = (i == OFormTabbedPaneUI.this.leadingTabIndex)
                        ? startPosition + (OFormTabbedPaneUI.this.leadingTabIndex > 0 ? buttonLength : 0)
                ...
                int length = (int) (OFormTabbedPaneUI.this.orientation.getLength(OFormTabbedPaneUI.this.rects[i])
                        * multiplier);
        ...
        protected void setScrollButtonPositions(Component child, boolean visible, int position) {
            if (visible) {
                child.setBounds(OFormTabbedPaneUI.this.orientation.createBounds(position,
                        OFormTabbedPaneUI.this.orientation
                            .getOrthogonalOffset(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.leadingTabIndex]),
                        OFormTabbedPaneUI.this.orientation.getLength(child.getPreferredSize()),
                        OFormTabbedPaneUI.this.orientation
                            .getThickness(OFormTabbedPaneUI.this.rects[OFormTabbedPaneUI.this.leadingTabIndex])));
            }
        ...
        protected void flipRightToLeft(int tabCount, Dimension size) {
            ...
            for (int i = 0; i < tabCount; i++) {
                OFormTabbedPaneUI.this.rects[i].x = rightMargin - OFormTabbedPaneUI.this.rects[i].x
                        - OFormTabbedPaneUI.this.rects[i].width;
            }
