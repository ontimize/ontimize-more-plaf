...
public class OntimizeRootPaneUI extends BasicRootPaneUI {
    ...
    protected class MouseInputHandler implements MouseInputListener {
        ...
        public void mousePressed(MouseEvent mouseevent) {
            ...
            Point point1 = SwingUtilities.convertPoint(OntimizeRootPaneUI.this.window, point,
                    OntimizeRootPaneUI.this.titlePane);
            int i = this.position2Cursor(OntimizeRootPaneUI.this.window, mouseevent.getX(), mouseevent.getY());
            if ((i == 0) && (OntimizeRootPaneUI.this.titlePane != null)
                    && OntimizeRootPaneUI.this.titlePane.contains(point1)
                ...
                this.dragDimension = new Dimension(OntimizeRootPaneUI.this.window.getWidth(),
                        OntimizeRootPaneUI.this.window.getHeight());
        ...
        public void mouseDragged(MouseEvent mouseevent) {
            ...
            if (this.windowAction == MouseInputHandler.WINDOW_MOVE) {
                ...
                if ((this.resizeType == MouseInputHandler.RIGHT_RESIZE)
                        || (this.resizeType == MouseInputHandler.TOP_RIGHT_RESIZE)
                        || (this.resizeType == MouseInputHandler.DOWN_RIGHT_RESIZE)) {
                ...
                if ((this.resizeType == MouseInputHandler.DOWN_RESIZE)
                        || (this.resizeType == MouseInputHandler.DOWN_LEFT_RESIZE)
                        || (this.resizeType == MouseInputHandler.DOWN_RIGHT_RESIZE)) {
                    // rectangle.height =
                ...
                if ((this.resizeType == MouseInputHandler.TOP_RESIZE)
                        || (this.resizeType == MouseInputHandler.TOP_LEFT_RESIZE)
                        || (this.resizeType == MouseInputHandler.TOP_RIGHT_RESIZE)) {
                ...
                if ((this.resizeType == MouseInputHandler.LEFT_RESIZE)
                        || (this.resizeType == MouseInputHandler.TOP_LEFT_RESIZE)
                        || (this.resizeType == MouseInputHandler.DOWN_LEFT_RESIZE)) {
        ...
        protected int position2Cursor(Window window, int x, int y) {
            Insets insets = OntimizeRootPaneUI.this.rootPane.getBorder()
                .getBorderInsets(OntimizeRootPaneUI.this.rootPane);
        ...
        if (style != JRootPane.NONE) {
            root.setBorder(new Border() {
                ...
                public void paintBorder(Component component, Graphics g, int x, int y, int width, int height) {
                    javax.swing.plaf.synth.SynthContext synthcontext = OntimizeLookAndFeel
                        .createContext((JComponent) component, Region.ROOT_PANE, 0);
                ...
                public Insets getBorderInsets(Component c) {
                    if ((OntimizeRootPaneUI.this.window instanceof Frame)
                            && ((((Frame) OntimizeRootPaneUI.this.window).getExtendedState()
