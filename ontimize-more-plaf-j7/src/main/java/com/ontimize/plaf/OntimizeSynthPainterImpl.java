 ...
 * </p>
 * This class is very similar to SynthPainterImpl. It is override due to there
 * are a lot of variables and methods protected, that we need to be public.
 *
...
public class OntimizeSynthPainterImpl extends SynthPainter {
	 ...
	 * @param x
	 *            the left-most portion of the object to paint.
	 * @param y
	 *            the upper-most portion of the object to paint.
	 * @param w
	 *            the width to paint.
	 * @param h
	 *            the height to paint.
	 * @param transform
	 *            the affine transform to apply, or {@code null} if none is to
	 *            be applied.
	 */
	protected void paint(Painter p, SynthContext ctx, Graphics g, int x, int y, int w, int h, AffineTransform transform) {
		if (p != null) {
	 ...
	 * @param x
	 *            the x location corresponding to the upper-left coordinate to
	 *            paint.
	 * @param y
	 *            the y location corresponding to the upper left coordinate to
	 *            paint.
	 * @param w
	 *            the width to paint.
	 * @param h
	 ...
	 *            be applied.
	 */
	protected void paintBackground(SynthContext ctx, Graphics g, int x, int y, int w, int h, AffineTransform transform) {
	 ...
	 *            the height to paint.
	 * @param orientation
	 *            the component's orientation, used to construct an affine
	 *            transform.
	 */
	 ...
	 *            Height of the area to paint to
	 * @param orientation
	 *            Orientation of the JScrollBar, one of <code>
	 ...
	 *            Height of the area to paint to
	 * @param orientation
	 *            One of <code>JTabbedPane.TOP</code>, <code>
