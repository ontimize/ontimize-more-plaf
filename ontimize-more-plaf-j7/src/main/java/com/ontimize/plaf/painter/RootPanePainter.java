...
public class RootPanePainter {
    ...
    public void paintRootPaneBorder(JRootPane rootPane, int state, Graphics graphics, int x, int y, int width,
        ...
        Object uiColor = OntimizeLookAndFeel.lookup(this.getComponentKeyName() + ".border.background");
        ...
        Object arc = OntimizeLookAndFeel.lookup(this.getComponentKeyName() + ".border.arc");
        int borderArc = 13;
    ...
    public void paintRootPaneBorder(SynthContext synthcontext, Graphics g, int x, int y, int width, int height) {
        ...
        this.paintRootPaneBorder(jrootpane, synthcontext.getComponentState(), g, x, y, width, height);
    }
