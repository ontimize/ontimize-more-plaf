...
public abstract class AbstractRegionPainter implements Painter<JComponent> {
    ...
    protected void prepare(float w, float h) {
        ...
        this.rightScale = (this.ctx.canvasSize.width - this.ctx.b) == 0f ? 0f : this.rightWidth
                / (this.ctx.canvasSize.width - this.ctx.b);
        ...
        this.bottomScale = (this.ctx.canvasSize.height - this.ctx.d) == 0f ? 0f : this.bottomHeight
                / (this.ctx.canvasSize.height - this.ctx.d);
    }
