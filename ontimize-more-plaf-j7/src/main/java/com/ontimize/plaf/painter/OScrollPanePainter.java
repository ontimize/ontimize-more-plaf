...
public class OScrollPanePainter extends AbstractRegionPainter {
    ...
    protected void init() {
        ...
        this.scrollBarCornerColor = (Color) UIManager.getLookAndFeelDefaults().get(
                this.getComponentKeyName() + "[Enabled].border");
    ...
    protected Shape decodeBorderPath(JComponent c, double x, double y, double w, double h, int borderIndex) {
        ...
        if (textComp != null) {
            ...
            this.path.curveTo(x_arc - radius - borderIndex, y + h - radius / 2.0, x_arc - radius / 2.0, y + h, x_arc, y
                    + h);
