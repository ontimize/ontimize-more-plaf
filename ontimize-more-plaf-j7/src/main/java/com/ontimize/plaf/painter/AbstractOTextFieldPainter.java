...
public abstract class AbstractOTextFieldPainter extends AbstractRegionPainter {
    ...
    protected Paint getBackgroundForState(JComponent c) {
        ...
        case BORDER_FOCUSED:
            ...
            break;
        case BORDER_FOCUSED_REQUIRED:
            paint = this.backgroundColorRequired != null ? this.backgroundColorRequired : c.getBackground();
            break;
        default:
    ...
    protected Paint decodeTopInnerShadowGradient(Shape s) {
        ...
        return this.decodeGradient(x, y, x, y + h, new float[] { 0.0f, 1.0f }, new Color[] {
                this.degradatedEditorInnerBorderColor[0], this.degradatedEditorInnerBorderColor[1] });
    }
    ...
    protected Paint decodeBottomInnerShadowGradient(Shape s) {
        ...
        float h = (float) bounds.getHeight();
        return this.decodeGradient(x, y, x, y + h, new float[] { 0.0f, 1.0f }, new Color[] {
                this.degradatedEditorInnerBorderColor[1], this.degradatedEditorInnerBorderColor[0] });
    }
    ...
    protected Paint decodeLeftInnerShadowGradient(Shape s) {
        ...
        return this.decodeGradient(x, y, x + w, y, new float[] { 0.0f, 1.0f }, new Color[] {
                this.degradatedEditorInnerBorderColor[0], this.degradatedEditorInnerBorderColor[1] });
    }
