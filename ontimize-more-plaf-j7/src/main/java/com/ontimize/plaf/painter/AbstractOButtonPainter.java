        ...
        switch (this.state) {
            case BACKGROUND_DEFAULT:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaDefaultPercent >= 0) && (this.alphaDefaultPercent <= 1))
                            ? this.alphaDefaultPercent : this.defaultAlphaDefaultPercent);
                break;
            case BACKGROUND_DEFAULT_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaFocusedDefaultPercent >= 0) && (this.alphaFocusedDefaultPercent <= 1))
                            ? this.alphaFocusedDefaultPercent
                            : this.defaultAlphaFocusedDefaultPercent);
                break;
            case BACKGROUND_MOUSEOVER_DEFAULT:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaMouseOverDefaultPercent >= 0) && (this.alphaMouseOverDefaultPercent <= 1))
                            ? this.alphaMouseOverDefaultPercent
                            : this.defaultAlphaMouseOverDefaultPercent);
                break;
            case BACKGROUND_MOUSEOVER_DEFAULT_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaMouseOverDefaultFocusedPercent >= 0)
                            && (this.alphaMouseOverDefaultFocusedPercent <= 1))
                                    ? this.alphaMouseOverDefaultFocusedPercent
                                    : this.defaultAlphaMouseOverDefaultFocusedPercent);
                break;
            case BACKGROUND_PRESSED_DEFAULT:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaPressedDefaultPercent >= 0) && (this.alphaPressedDefaultPercent <= 1))
                            ? this.alphaPressedDefaultPercent
                            : this.defaultAlphaPressedDefaultPercent);
                break;
            case BACKGROUND_PRESSED_DEFAULT_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaPressedDefaultFocusedPercent >= 0)
                            && (this.alphaPressedDefaultFocusedPercent <= 1)) ? this.alphaPressedDefaultFocusedPercent
                                    : this.defaultAlphaPressedDefaultFocusedPercent);
                break;
            case BACKGROUND_DISABLED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaDisabledPercent >= 0) && (this.alphaDisabledPercent <= 1))
                            ? this.alphaDisabledPercent
                            : this.defaultAlphaDisabledPercent);
                break;
            case BACKGROUND_ENABLED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaEnabledPercent >= 0) && (this.alphaEnabledPercent <= 1))
                            ? this.alphaEnabledPercent : this.defaultAlphaEnabledPercent);
                break;
            case BACKGROUND_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaFocusedPercent >= 0) && (this.alphaFocusedPercent <= 1))
                            ? this.alphaFocusedPercent : this.defaultAlphaFocusedPercent);
                break;
            case BACKGROUND_MOUSEOVER:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaMouseOverPercent >= 0) && (this.alphaMouseOverPercent <= 1))
                            ? this.alphaMouseOverPercent
                            : this.defaultAlphaMouseOverPercent);
                break;
            case BACKGROUND_MOUSEOVER_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaMouseOverFocusedPercent >= 0) && (this.alphaMouseOverFocusedPercent <= 1))
                            ? this.alphaMouseOverFocusedPercent
                            : this.defaultAlphaMouseOverFocusedPercent);
                break;
            case BACKGROUND_PRESSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaPressedPercent >= 0) && (this.alphaPressedPercent <= 1))
                            ? this.alphaPressedPercent : this.defaultAlphaPressedPercent);
                break;
            case BACKGROUND_PRESSED_FOCUSED:
                alpha = AlphaComposite.SrcOver
                    .derive(((this.alphaPressedFocusedPercent >= 0) && (this.alphaPressedFocusedPercent <= 1))
                            ? this.alphaPressedFocusedPercent
