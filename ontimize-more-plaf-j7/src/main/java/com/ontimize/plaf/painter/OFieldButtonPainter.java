...
public class OFieldButtonPainter extends AbstractOButtonPainter{
	...
	protected void doPaint(Graphics2D g, JComponent c, int width, int height,
		...
		switch (state) {
		case BACKGROUND_DEFAULT_FOCUSED: paintBackgroundDefaultAndFocused(g);
			break;
		case BACKGROUND_FOCUSED: paintBackgroundFocused(g);
			break;
		}
	}
	...
	protected void init (){
		...
		Object obj = UIManager.getDefaults().get("\"FieldButton\"[Focused].background");
