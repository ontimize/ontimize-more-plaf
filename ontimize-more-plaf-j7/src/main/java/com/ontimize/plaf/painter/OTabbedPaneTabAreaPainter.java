...
public class OTabbedPaneTabAreaPainter extends AbstractRegionPainter {
	...
	protected void paintBackground(Graphics2D g, JComponent c, Paint borderColor, Paint bgColor) {
		...
		if (c instanceof JTabbedPane) {
			...
			Shape degradedLine = this.createRectangle(x, y, this.decodeX(2.0f) - this.decodeX(1.0f), OTabbedPanePainter.borderWidth);
	...
	protected Paint decodeLineGradient(JComponent c, Shape s, Color color) {
		...
		Color[] colors = new Color[] { OntimizeLAFColorUtils.setAlpha(color, OTabbedPanePainter.maxAlphaBorderColor), OntimizeLAFColorUtils.setAlpha(color, 0.095) };
