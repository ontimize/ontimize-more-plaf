...
public class RootPaneImagePainter {
    ...
    public void paintRootPaneBorder(JRootPane rootPane, int state, Graphics graphics, int x, int y, int width,
            int height) {
        ...
        // Insets insets = (Insets)OntimizeLookAndFeel.getInsets("Synthetica.rootPane.border.insets",
        // window).clone();
        ...
        // // i1 += SyntheticaLookAndFeel.get("Synthetica.rootPane.border.size", window) != null ?
        // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.border.size", window).top : 4;
        // i1+=4;
        // insets.top = i1;
        // }
        ...
        // int l1 = 0;
        // if(OntimizeLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.background.horizontalTiled",
        // window))
        // l1 = 1;
        // int i2 = 0;
        // if(OntimizeLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.background.verticalTiled",
        // window))
        // i2 = 1;
        // if(OntimizeLookAndFeel.isEvalCopy() && !flag)
        // j1 -= 16;
        // if(OS.getCurrentOS() == OS.Mac && (!OntimizeLookAndFeel.isWindowOpacityEnabled(window) ||
        // OntimizeLookAndFeel.isWindowShapeEnabled(window)))
        // g.clearRect(i, j, k, j1);

        // ImagePainter imagepainter = new ImagePainter(rootPane, graphics, x, y, k, j1, s, insets, insets1,
        // l1, i2);
        // if(flag)
        ...
        // s = OntimizeLookAndFeel.getString(s, window);
        // if(s != null){
        // ImagePainter imagepainter1 = new ImagePainter(rootPane, graphics, i, j, k, j1, s, insets,
        // insets1, 0, 1);
        // if(flag)
        ...
        ImagePainter painter = new ImagePainter(0, true, true, new Insets(20, 5, 5, 5), null,
                getClass().getClassLoader().getResource(s), true) {
            @Override
        ...
        // if(SyntheticaLookAndFeel.getBoolean("Synthetica.rootPane.paintStatusBar", window) &&
        // rootPane.getClientProperty("Synthetica.statusBar") != null)
        // {
        // int k1 = l;
        // if(SyntheticaRootPaneUI.isEvalCopy() && !flag)
        // k1 -= 16;
        // int j2 = ((JComponent)rootPane.getClientProperty("Synthetica.statusBar")).getHeight();
        // j2 += SyntheticaLookAndFeel.get("Synthetica.rootPane.border.size", window) != null ?
        // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.border.size", window).top : 4;
        // SyntheticaAddonsPainter.getInstance("Synthetica.StatusBarPainter").paintStatusBarBackground(rootPane,
        // new SyntheticaState(), graphics, 0, k1 - j2, k, j2);
        // }
        ...
        // graphics.drawString("Synthetica - Unregistered Evaluation Copy!", 4, (l - 16) +
    ...
    public void paintContentBackground(JRootPane jrootpane, int state, Graphics g, int i, int j, int k, int l) {
        ...
        // s = (new StringBuilder(String.valueOf(s))).append(".selected").toString();
        // s = SyntheticaLookAndFeel.getString(s, window);
        // Insets insets = SyntheticaLookAndFeel.get("Synthetica.rootPane.border.size", window) != null ?
        // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.border.size", window) : new Insets(4, 4, 4,
        // 4);
        // Insets insets1 = (Insets)insets.clone();
        // insets1.top += ((SyntheticaRootPaneUI)jrootpane.getUI()).getTitlePane().getHeight();
        // Insets insets2 = new Insets(0, 0, 0, 0);
        // int i1 = 0;
        // if(SyntheticaLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.background.horizontalTiled",
        // window))
        // i1 = 1;
        // int j1 = 0;
        // if(SyntheticaLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.background.verticalTiled",
        // window))
        // j1 = 1;
        ...
        // imagepainter1.drawCenter();
        // }
        // MenuPainter.getInstance().paintMenuBarBackground(jrootpane, new SyntheticaState(), g, i, j, k,
        // l);
    }

    // protected void renderLogo(JRootPane jrootpane, boolean flag, boolean flag1, boolean flag2,
    // Graphics g, int i, int j)
    // {
    // SyntheticaLogoRenderer syntheticalogorenderer =
    // (SyntheticaLogoRenderer)jrootpane.getClientProperty("Synthetica.logoRenderer");
    ...
    // JMenuBar jmenubar = (JMenuBar)SyntheticaLookAndFeel.findComponent(javax/swing/JMenuBar,
    // jrootpane);
    // boolean flag3 = jrootpane.getClientProperty("Synthetica.logoRenderer.titlePaneOnly") != null ?
    // ((Boolean)jrootpane.getClientProperty("Synthetica.logoRenderer.titlePaneOnly")).booleanValue() :
    // false;
    // if(jmenubar != null && SyntheticaLookAndFeel.get("Synthetica.menuBar.background.active",
    // jmenubar) == null && !flag3)
    // k += jmenubar.getHeight();
    // boolean flag4 = jrootpane.getClientProperty("Synthetica.logoRenderer.respectButtons") != null ?
    // ((Boolean)jrootpane.getClientProperty("Synthetica.logoRenderer.respectButtons")).booleanValue() :
    // false;
    // if(flag4)
    // {
    // Rectangle rectangle =
    // ((SyntheticaTitlePane)((SyntheticaRootPaneUI)jrootpane.getUI()).getTitlePane()).getMenuButtonBounds();
    // Rectangle rectangle1 =
    // ((SyntheticaTitlePane)((SyntheticaRootPaneUI)jrootpane.getUI()).getTitlePane()).getControlButtonsBounds();
    ...
    // public void paintTitlePaneBackground(JRootPane jrootpane, SyntheticaState syntheticastate,
    // Graphics g, int i, int j, int k, int l)
    // {
    // Window window = getWindow(jrootpane);
    // boolean flag = SyntheticaLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.opaque", window,
    // true);
    ...
    // s = SyntheticaLookAndFeel.getString(s, window);
    // Insets insets =
    // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.titlePane.background.insets", window);
    // int i1 = 0;
    // if(SyntheticaLookAndFeel.getBoolean("Synthetica.rootPane.titlePane.background.horizontalTiled",
    // window))
    // i1 = 1;
    ...
    // }
    //
    // public void paintTitlePaneBackground(SynthContext synthcontext, Graphics g, int i, int j, int k,
    // int l){
    // JRootPane jrootpane = (JRootPane)synthcontext.getComponent();
    // paintTitlePaneBackground(jrootpane, new SyntheticaState(synthcontext.getComponentState()), g, i,
    // j, k, l);
    // }
    ...
    // public void paintButtonAreaBackground(SynthContext synthcontext, Graphics g, int i, int j, int k,
    // int l)
    // {
    // JRootPane jrootpane = (JRootPane)synthcontext.getComponent();
    // Window window = getWindow(jrootpane);
    ...
    // Insets insets =
    // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.titlePane.buttonArea.insets", window);
    // if(insets != null){
    // i -= insets.left;
    // j -= insets.top;
    ...
    // if(flag &&
    // SyntheticaLookAndFeel.getString("Synthetica.rootPane.titlePane.buttonArea.background.selected",
    // window) != null)
    // s = (new StringBuilder(String.valueOf(s))).append(".selected").toString();
    // s = SyntheticaLookAndFeel.getString(s, window);
    // Insets insets1 =
    // SyntheticaLookAndFeel.getInsets("Synthetica.rootPane.titlePane.buttonArea.background.insets",
    // window);
