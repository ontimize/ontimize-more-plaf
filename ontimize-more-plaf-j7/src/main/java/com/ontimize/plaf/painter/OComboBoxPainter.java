...
public class OComboBoxPainter extends AbstractRegionPainter {
    ...
    protected void paintBackgroundDisabled(Graphics2D g) {
        ...
        if (this.isTableEditor()) {
            this.drawBackgroundTableEditor(g,
                    this.getBackgroundColor(this.getComponent(), this.backgroundColorDisabled));
        } else {
    ...
    protected void paintBackgroundMouseOverAndFocused(Graphics2D g) {
        ...
        if (this.isTableEditor()) {
            this.drawBackgroundTableEditor(g,
                    this.getBackgroundColor(this.getComponent(), this.backgroundColorFocusedMouseOver));
        } else {
    ...
    protected void paintBackgroundMouseOver(Graphics2D g) {
        ...
        if (this.isTableEditor()) {
            this.drawBackgroundTableEditor(g,
                    this.getBackgroundColor(this.getComponent(), this.backgroundColorMouseOver));
        } else {
    ...
    protected void paintBackgroundPressedAndFocused(Graphics2D g) {
        ...
        if (this.isTableEditor()) {
            this.drawBackgroundTableEditor(g,
                    this.getBackgroundColor(this.getComponent(), this.backgroundColorFocusedPressed));
        } else {
    ...
    protected void paintBackgroundFocusedAndEditable(Graphics2D g) {
        ...
        if (this.isTableEditor()) {
            ...
            this.drawBackgroundEditable(g,
                    this.getBackgroundColor(this.getComponent(), this.backgroundEditorColorEnabled));
            this.drawDegradatedBorders(g, this.degradatedBorderColorFocused);
        }
    ...
    protected Paint decodeGradientButton(Shape s, Color bgBaseColor) {
        ...
        return this.decodeGradient(x, y, x, y + h, new float[] { 0.0f, 0.495f, 0.505f, 1.0f }, new Color[] {
                bgBaseColor, derived, derived, bgBaseColor });
    }
