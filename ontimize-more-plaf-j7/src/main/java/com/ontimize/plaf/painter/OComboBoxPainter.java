...
public class OComboBoxPainter extends AbstractRegionPainter {
	...
	protected Object[] getExtendedCacheKeys(JComponent c) {
		...
		switch (this.state) {
		case BACKGROUND_ENABLED:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color17, -0.63174605f, 0.43921566f, 0),
		...
		case BACKGROUND_FOCUSED:
			...
			break;
		case BACKGROUND_MOUSEOVER_FOCUSED:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color29, -0.6317773f, 0.4470588f, 0),
		...
		case BACKGROUND_MOUSEOVER:
			...
			break;
		case BACKGROUND_PRESSED_FOCUSED:
			extendedCacheKeys = new Object[] { this.getComponentColor(c, "background", this.color41, -0.5847884f, 0.2980392f, 0),
