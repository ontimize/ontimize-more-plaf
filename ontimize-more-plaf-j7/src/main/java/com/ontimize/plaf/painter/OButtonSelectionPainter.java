...
public class OButtonSelectionPainter extends AbstractOButtonPainter {
    ...
    protected void init() {
        ...
        if (obj instanceof Color) {
            ...
            this.focusBgColor = OButtonSelectionPainter.defaultFocusBgColor;
        }
    ...
    protected void paintBackgroundDefaultAndFocused(Graphics2D g) {
        ...
        g.setPaint(this.focusBgColor != null ? this.focusBgColor : OButtonSelectionPainter.defaultFocusBgColor);
