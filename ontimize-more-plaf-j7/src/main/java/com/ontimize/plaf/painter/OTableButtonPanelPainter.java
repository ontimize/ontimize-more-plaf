...
public class OTableButtonPanelPainter extends AbstractRegionPainter {
	...
	protected void paintBackground(Graphics2D g, JComponent c, int width, int height) {
		...
		GradientPaint downPaint = new GradientPaint(0, height, this.bottomBackgroundColor, 0, this.decodeHeight(height), this.topBackgroundColor);
		Graphics2D g2D = g;
		...
		g.setColor(this.topBackgroundColor);
		g.fill(s);
		g.setColor(oldC);
	}
