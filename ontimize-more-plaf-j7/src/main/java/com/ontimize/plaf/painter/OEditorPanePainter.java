...
public class OEditorPanePainter extends OTextAreaPainter {
    ...
    protected void paintBorderInScrollPane(Graphics2D g, JComponent c, int x, int y, Paint color) {
        ...
        if ((vScrollBar != null) && vScrollBar.isVisible()) {
            ...
            g.drawLine(bounds.width - numBorders, y + numBorders, bounds.width - numBorders,
                    y + numBorders + c.getInsets().top);
        } else {
            g.setPaint(color);
            s = ShapeFactory.getInstace()
                .createRoundCorner(c.getBounds().width - numBorders, y + numBorders,
                        c.getInsets().right - numBorders - 1,
        ...
        if (((vScrollBar != null) && vScrollBar.isVisible()) || ((hScrollBar != null) && hScrollBar.isVisible())) {
            g.setPaint(this.getPaintForFiller(c, s));
            g.drawLine(bounds.width - numBorders - c.getInsets().right, c.getBounds().height - numBorders,
                    bounds.width - numBorders, c.getBounds().height - numBorders);
            g.drawLine(bounds.width - numBorders, c.getBounds().height - numBorders, bounds.width - numBorders,
                    c.getBounds().height - numBorders - c.getInsets().bottom);
        } else {
            g.setPaint(color);
            s = ShapeFactory.getInstace()
                .createRoundCorner(c.getBounds().width - numBorders, c.getBounds().height - numBorders,
                        c.getInsets().right - numBorders - 1,
        ...
        if ((hScrollBar != null) && hScrollBar.isVisible()) {
            g.setPaint(this.getPaintForFiller(c, s));
            g.drawLine(x + numBorders, c.getBounds().height - numBorders - insets.bottom, x + numBorders,
                    c.getBounds().height - numBorders);
            g.drawLine(x + numBorders, c.getBounds().height - numBorders, x + numBorders + c.getInsets().left,
                    c.getBounds().height - numBorders);
        } else {
            g.setPaint(color);
            s = ShapeFactory.getInstace()
                .createRoundCorner(x + numBorders, c.getBounds().height - numBorders, c.getInsets().left - numBorders,
        ...
        g.drawLine((x + numBorders + insets.left) - 1, bounds.height - numBorders - 1, bounds.width - insets.right,
                bounds.height - numBorders - 1);
        ...
        g.drawLine(bounds.width - numBorders - 1, (y + numBorders + insets.top) - 1, bounds.width - numBorders - 1,
    ...
    protected void defineBorderFillersInScrollPane(Graphics2D g, JComponent c, int x, int y) {
        ...
        Shape s = ShapeFactory.getInstace()
            .createRectangle(x + numBorders, y + numBorders, c.getInsets().left - numBorders - 1,
                    c.getInsets().top - numBorders);
        g.setPaint(this.getPaintForFiller(c, s));
        g.fill(s);
        ...
        if ((vScrollBar != null) && vScrollBar.isVisible()) {
            s = ShapeFactory.getInstace()
                .createRectangle(bounds.width - insets.right, y + numBorders, c.getInsets().right - numBorders,
                        c.getInsets().top - numBorders);
            g.fill(s);
        } else {
            s = ShapeFactory.getInstace()
                .createRoundCorner(c.getBounds().width - numBorders, y + numBorders,
                        c.getInsets().right - numBorders - 1, c.getInsets().top - numBorders,
        ...
        if (((vScrollBar != null) && vScrollBar.isVisible()) || ((hScrollBar != null) && hScrollBar.isVisible())) {
            s = ShapeFactory.getInstace()
                .createRectangle(bounds.width - insets.right, bounds.height - numBorders - insets.bottom,
                        insets.right - numBorders,
                        c.getInsets().bottom - numBorders);
            g.fill(s);
        } else {
            s = ShapeFactory.getInstace()
        ...
        if ((hScrollBar != null) && hScrollBar.isVisible()) {
            s = ShapeFactory.getInstace()
                .createRectangle(x + numBorders, c.getBounds().height - numBorders - insets.bottom,
                        c.getInsets().left - numBorders,
                        c.getInsets().bottom - numBorders);
            g.fill(s);
        } else {
            s = ShapeFactory.getInstace()
                .createRoundCorner(x + numBorders, c.getBounds().height - numBorders,
                        c.getInsets().left - numBorders - 1,
        ...
        // top
        s = ShapeFactory.getInstace()
            .createRectangle(insets.left - 1, y + numBorders, (bounds.width - insets.left - insets.right) + 2,
                    insets.top - numBorders);
        g.fill(s);
        // bottom
        s = ShapeFactory.getInstace()
            .createRectangle(insets.left - 1, (y + bounds.height) - insets.bottom,
                    (bounds.width - insets.left - insets.right) + 2,
                    insets.bottom - numBorders);
        g.fill(s);
        // left
        s = ShapeFactory.getInstace()
            .createRectangle(x + numBorders, insets.top, insets.right - numBorders - 1,
                    bounds.height - insets.top - insets.bottom);
        g.fill(s);
        // right
        s = ShapeFactory.getInstace()
            .createRectangle(((x + bounds.width) - insets.right) + 1, insets.top, insets.right - numBorders - 1,
                    bounds.height - insets.top - insets.bottom);
        g.fill(s);
