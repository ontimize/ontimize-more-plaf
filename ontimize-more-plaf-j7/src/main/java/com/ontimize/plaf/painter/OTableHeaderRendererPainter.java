...
public class OTableHeaderRendererPainter extends AbstractRegionPainter {
	...
	protected Paint decodeGradient1(Shape s) {
		...
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.14441223f, 0.43703705f, 0.59444445f, 0.75185186f,
				0.8759259f, 1.0f }, new Color[] { this.color2, this.decodeColor(this.color2, this.color3, 0.5f), this.color3, this.decodeColor(this.color3, this.color4, 0.5f),
	...
	protected Paint decodeGradient2(Shape s) {
		...
		float w = (float) bounds.getWidth();
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.07147767f, 0.2888889f, 0.5490909f, 0.7037037f, 0.8518518f,
				1.0f }, new Color[] { this.color6, this.decodeColor(this.color6, this.color7, 0.5f), this.color7, this.decodeColor(this.color7, this.color8, 0.5f), this.color8,
	...
	protected Paint decodeBgGradient(Shape s) {
		...
		float y = (float) bounds.getY();
		float h = (float) bounds.getHeight();
		return this.decodeGradient(x, y, x, (1.0f * h) + y, new float[] { 0.0f, 1.0f }, new Color[] { this.bgHeaderGradientInit, this.bgHeaderGradientEnd });
	}
	...
	protected Paint decodeGradient3(Shape s) {
		...
		float w = (float) bounds.getWidth();
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.07147767f, 0.2888889f, 0.5490909f, 0.7037037f, 0.7919203f,
				0.88013697f }, new Color[] { this.color11, this.decodeColor(this.color11, this.color12, 0.5f), this.color12, this.decodeColor(this.color12, this.color13, 0.5f),
	...
	protected Paint decodeGradient4(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.07147767f, 0.2888889f, 0.5490909f, 0.7037037f, 0.8518518f,
				1.0f }, new Color[] { this.color15, this.decodeColor(this.color15, this.color16, 0.5f), this.color16, this.decodeColor(this.color16, this.color17, 0.5f),
	...
	protected Paint decodeGradient6(Shape s) {
		...
		float h = (float) bounds.getHeight();
		return this.decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, new float[] { 0.0f, 0.07147767f, 0.2888889f, 0.5490909f, 0.7037037f, 0.8518518f,
				1.0f }, new Color[] { this.color19, this.decodeColor(this.color19, this.color23, 0.5f), this.color23, this.decodeColor(this.color23, this.color21, 0.5f),
