...
/**
 * Menu painter for menus IN the MENU BAR (to configure border and foreground colors, painters,
 * images, ...)
 *
...
public class OMenuBarMenuPainter extends AbstractRegionPainter {
    ...
    protected Shape decodeBackground(JComponent c) {
        ...
        if ((popUpWidth != -1) && (popUpWidth < c.getWidth())) {
            ...
            this.path.curveTo(this.decodeX(0.0f) + numBorders + this.shadowWidth,
                    this.decodeY(1.0f) + (arcRadius / 2.0), this.decodeX(0.0f) + numBorders + this.shadowWidth
                            + (arcRadius / 2.0),
                    this.decodeY(1.0f), this.decodeX(0.0f) + numBorders + this.shadowWidth + arcRadius,
                    this.decodeY(1.0f));
            this.path.lineTo(this.decodeX(3.0f) - numBorders - this.shadowWidth - arcRadius, this.decodeY(1.0f));
            this.path.curveTo(this.decodeX(3.0f) - numBorders - this.shadowWidth - (arcRadius / 2.0),
                    this.decodeY(1.0f), this.decodeX(3.0f) - numBorders - this.shadowWidth,
                    this.decodeY(1.0f) + (arcRadius / 2.0), this.decodeX(3.0f) - numBorders - this.shadowWidth,
                    this.decodeY(1.0f) + arcRadius);
            this.path.lineTo(this.decodeX(3.0f) - numBorders - this.shadowWidth,
                    this.decodeY(3.0f) - numBorders - arcRadius);
            this.path.curveTo(this.decodeX(3.0f) - numBorders - this.shadowWidth,
                    this.decodeY(3.0f) - numBorders - (arcRadius / 2.0), this.decodeX(3.0f) - 1 - numBorders
                            - this.shadowWidth - (arcRadius / 2.0),
                    this.decodeY(3.0f) - numBorders,
                    this.decodeX(3.0f) - 1 - numBorders - this.shadowWidth - (arcRadius / 2.0),
                    this.decodeY(3.0f) - numBorders);
            this.path.lineTo((this.decodeX(0.0f) + popUpWidth) - numBorders - this.shadowWidth,
                    this.decodeY(3.0f) - numBorders);
    ...
    protected Shape decodeBorder(JComponent c) {
        ...
        if ((popUpWidth != -1) && (popUpWidth < c.getWidth())) {
            ...
            this.path.curveTo(this.decodeX(0.0f) + this.shadowWidth, this.decodeY(0.0f) + (arcRadius / 2.0),
                    this.decodeX(0.0f) // top-left
                                       // corner
                            + this.shadowWidth + (arcRadius / 2.0),
                    this.decodeY(0.0f), this.decodeX(0.0f) + this.shadowWidth + arcRadius, this.decodeY(0.0f));
            ...
            this.path.curveTo(this.decodeX(3.0f) - this.shadowWidth - (arcRadius / 2.0), this.decodeY(0.0f),
                    this.decodeX(3.0f) // top-right
                                       // corner
                            - this.shadowWidth,
                    this.decodeY(0.0f) + (arcRadius / 2.0), this.decodeX(3.0f) - this.shadowWidth,
            ...
            this.path.curveTo(this.decodeX(3.0f) - this.shadowWidth, this.decodeY(3.0f) - (arcRadius / 2.0), // bottom-right
                                                                                                             // corner
                    this.decodeX(3.0f) - this.shadowWidth - (arcRadius / 2.0), this.decodeY(3.0f),
                    this.decodeX(3.0f) - this.shadowWidth - arcRadius, this.decodeY(3.0f));
