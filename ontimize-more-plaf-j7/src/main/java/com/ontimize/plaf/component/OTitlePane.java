...
public class OTitlePane extends JComponent {
	...
	protected class SystemMenuBar extends JMenuBar {
		...
		public Dimension getPreferredSize() {
			...
			return new Dimension(Math.max(OTitlePane.IMAGE_WIDTH, size.width), Math.max(size.height, OTitlePane.IMAGE_HEIGHT));
		}
	}
	...
	protected class TitlePaneLayout implements LayoutManager {
		...
		public void layoutContainer(Container c) {
			boolean leftToRight = (OTitlePane.this.window == null) ? OTitlePane.this.getRootPane().getComponentOrientation().isLeftToRight() : OTitlePane.this.window
