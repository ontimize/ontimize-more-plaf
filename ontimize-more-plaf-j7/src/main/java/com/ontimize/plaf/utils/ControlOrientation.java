 ...
 * {@link javax.swing.JTabbedPane}. The methods in this enumeration allow for orentation-agnostic
 * calculations, which can be used when laying out a scroll bar or tabbed pane tab area. A scroll
 * bar, regardless of its orientation, has a length and thickness, as does the tab area of a tabbed
 * pane. These values correspond to different dimensions (x or y) depending on the orientation.
 *
 * @author Imatia S.L.
 */
public enum ControlOrientation {
     ...
     * @return the {@code ControlOrientation} to the corresponding Swing scroll bar orientation.
     */
    ...
    /**
     * Gets the thickness of the given size. Thickness corresponds to the dimension that is orthogonal
     * to the main direction of the component. That is, a horizontal scroll bar's thickness corresponds
     * to the y dimension, while a vertical scroll bar's thickness corresponds to the x dimension.
    ...
    /**
     * Gets the thickness of the given rectangle. Thickness corresponds to the dimension that is
     * orthogonal to the main direction of the component. That is, a horizontal scroll bar's thickness
     * corresponds to the y dimension, while a vertical scroll bar's thickness corresponds to the x
     * dimension.
    ...
    /**
     * Gets the length of the given size. Length corresponds to the dimension that is in line with the
     * main direction of the component. That is, a horizontal scroll bar's length corresponds to the x
     * dimension, while a vertical scroll bar's length corresponds to the y dimension.
    ...
    /**
     * Gets the length of the given rectangle. Length corresponds to the dimension that is in line with
     * the main direction of the component. That is, a horizontal scroll bar's length corresponds to the
     * x dimension, while a vertical scroll bar's length corresponds to the y dimension.
    ...
    /**
     * Gets the position from the given {@link Point}. Position refers to the dimension of a point in
     * line with the main direction of the component. That is, a horiztonal scroll bar's position
     * corresponds to the x dimension, while a vertical scroll bar's position corresponds to the y
     * dimension.
    ...
    /**
     * Gets the position from the given {@link Rectangle}. Position refers to the dimension of a point
     * in line with the main direction of the component. That is, a horiztonal scroll bar's position
     * corresponds to the x dimension, while a vertical scroll bar's position corresponds to the y
     * dimension.
    ...
    /**
     * Gets the position value from the given x and y values. Position refers to the coordinate which is
     * in line with the main direction of the component. That is, a horiztonal scroll bar's value
     * corresponds to the x value, while a vertical scroll bar's value corresponds to the y value.
    ...
    /**
     * Gets the orthogonal offset from the given {@link Point}. Orthogonal offset refers to the
     * dimension of a point orthogonal to the main direction of the component. That is, a horiztonal
     * scroll bar's position corresponds to the x dimension, while a vertical scroll bar's position
    ...
    /**
     * Gets the orthogonal offset from the given {@link Rectangle}. Orthogonal offset refers to the
     * dimension of a point orthogonal to the main direction of the component. That is, a horiztonal
     * scroll bar's position corresponds to the x dimension, while a vertical scroll bar's position
     * corresponds to the y dimension.
    ...
    /**
     * Gets the orthogonal offset from the given x and y positions. Orthogonal offset refers to the
     * dimension of a point orthogonal to the main direction of the component. That is, a horiztonal
     * scroll bar's position corresponds to the x dimension, while a vertical scroll bar's position
     * corresponds to the y dimension.
    ...
    /**
     * Moves the given bounds to the given position. For a horiztonal scroll bar this translates into
     * {@code bounds.x = newPosition}, while for a vertical scroll bar this translates into
    ...
    /**
     * Moves the given bounds to the given orthogonal offset. For a horizontal scroll bar this
     * translates into {@code bounds.y = newOrthogonalOffset}, while for a vertical scroll bar this
     * translates into {@code bounds.x = newOrthogonalOffset}.
     * @param bounds the bounds to update with the new orthogonal offset.
     * @param newOrthogonalOffset the new orthogonal offset to set the bounds to.
     * @return the updated bounds.
     */
    public abstract Rectangle updateBoundsOrthogonalOffset(Rectangle bounds, int newOrthogonalOffset);

    /**
     * Resize the given bounds to the given length. For a horizontal scroll bar this translates into
     * {@code bounds.width = newLength}, while for a vertical scroll bar this translates into
    ...
    /**
     * Resize the given bounds to the given thickness. For a horizontal scroll bar this translates into
     * {@code bounds.height = newThickness}, while for a vertical scroll bar this translates into
    ...
    /**
     * Creates bounds based on the given {@link Component}, position and length. The supplied component
     * will be used to determine the thickness of the bounds. The position will be used to locate the
     * bounds along the scrollable axis. The length will be used to determine the length of the bounds
     * along the scrollable axis.
     *
     * <p>
    ...
    /**
     * Creates bounds based on the position, orthogonal offset, length, and thickness.
    ...
    /**
     * Creates bounds centered in the given {@link Component} located at the given position, with the
     * given thickness and length.
     *
     * <p>
     * Horizontal scroll bars, the bounds will be derived like this:
     *
