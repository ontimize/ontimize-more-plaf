 ...
 * the License.
 *
 * $Id: OTabCloseListener.java,v 1.2 2013/06/25 06:28:22 daniel.grana Exp $
 */
 ...
 * @author Imatia S.L.
 */
public interface OTabCloseListener {

    /**
     * Called when the user clicks on a close button.
     * @param tabIndex the tab to be closed.
     * @return {@code true} if the tab may be closed, {@code false} if the tab should not be closed.
     */
