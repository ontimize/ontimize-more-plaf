...
public class OntimizeLAFPainterUtils {
	...
	/**
	 * Decode the variable painter, in order to be able to call the same-named
	 * method with values in all the calling-parameters .
	 *
	 *
	 * @param s
	 * @param painter
	...
	/**
	 * Fill defaults CycleMethod value and calls the same-named method (see that
	 * javadoc for details)
	 *
	 * @param x
	 * @param y
	...
	/**
	 * This method performs the operation indicated by the input string (named
	 * operation), swapping the constants indicated by x, y, w, h by the input
	 * values. A float value with the operation result is returned.
	 *
	...
	/**
	 * This method converts the input string (named srcValue) to a float number
	 * (also if the string is a variable x, y , w or h)
	 *
	 * @param srcValue
	 * @param x
	 * @param y
