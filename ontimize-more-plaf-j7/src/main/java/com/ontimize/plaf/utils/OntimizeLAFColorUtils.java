...
public class OntimizeLAFColorUtils {
    ...
    /**
     * This method convert a color to the Ontimize Syntax used both in the cached values and in the
     * OntimizeLAFDefaultConfig.properties, that is RR;GG;BB;alpha where each value (between ;) is an
     * int between 0 and 255 (also the alpha value)
     * @param color
     * @param defaultValue
     * @return
     */
    ...
    /**
     * This method convert the received String to a color. This string must be a three-values(#rrggbb)
     * or four-values(#rrggbbaa) string, where each one of these values must be a hexadecimal number
     * between 00 and ff. In case that the string was a four-values the forth is used to indicate the
     * color alpha
     * @param hex
     * @return
     * @throws Exception
    ...
    /**
     * This method convert the received String to a color. This string must be a three-values(#rrggbb)
     * string, where each one of these values must be a hexadecimal number between 00 and ff. Also an
     * alpha can be indicated
     * @param hex
     * @param alpha
     * @return
     */
    ...
    /**
     * This method convert the received String to a color. This string must be a three-values(R;G;B) or
     * four-values(R;G;B;alpha) string, where each one of these values must be splitted by ; and they
     * must be a positive int between 0 and 255
    ...
    /**
     * This method convert the received String to a color. This string must be a three-values(R;G;B)
     * string, where each one of these values must be splitted by ; and they must be a positive int
     * between 0 and 255
    ...
    /**
     * Returns a new color equal to the old one, except alpha (transparency) channel is set to the new
     * value.
